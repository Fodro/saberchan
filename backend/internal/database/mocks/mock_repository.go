...
// ListStaleThreads mocks base method.
func (m *MockRepository) ListStaleThreads(ctx context.Context, before time.Time) ([]database.Thread, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListStaleThreads", ctx, before)
	ret0, _ := ret[0].([]database.Thread)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListStaleThreads indicates an expected call of ListStaleThreads.
func (mr *MockRepositoryMockRecorder) ListStaleThreads(ctx, before any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListStaleThreads", reflect.TypeOf((*MockRepository)(nil).ListStaleThreads), ctx, before)
}
